...
let response = document.getElementById("count_withdraw");
const span = document.createElement("span");
span.textContent = "Por favor insira o valor do saque!";

document.getElementById("withdraw_button").onclick = () => {
  document.getElementById("count_withdraw").innerHTML = "";
  let withdrawInputData = document.getElementById("inputData").value;
  span.textContent = withdraw(withdrawInputData, withdrawInputData);
